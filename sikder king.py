...
def sykology():
    ...
    for z in range(ehc_lim):
        ...
        emran.append(co)
    print(" \033[38;5;46m════════════════════════════════════")
    print(" \033[38;5;46m𝗘𝗠𝗥𝗔𝗡𝟭➲〱{𝗘𝗛𝗖}╔══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗠.}")
    print(" \033[38;5;46m𝗘𝗠𝗥𝗔𝗡𝟮➲〱{𝗘𝗛𝗖}╚══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗠-𝗕𝗔𝗦𝗜𝗖}")
    print(" \033[38;5;46m𝗘𝗠𝗥𝗔𝗡𝟯➲〱{𝗘𝗛𝗖}╔══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗙𝗥𝗘𝗘.}")
    print(" \033[38;5;46m𝗘𝗠𝗥𝗔𝗡𝟰➲〱{𝗘𝗛𝗖}╚══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗣.}")
    print(" \033[38;5;46m𝗘𝗠𝗥𝗔𝗡𝟱➲〱{𝗘𝗛𝗖}╔══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎{𝗫.}")
    print(" \033[38;5;46m𝗘𝗠𝗥𝗔𝗡𝟲➲〱{𝗘𝗛𝗖}╚══➻〱𝗨𝗣𝗗𝗔𝗧𝗘💎𝗙𝗨𝗖𝗞{𝗬𝗢𝗨}")
    print(" \033[38;5;46m════════════════════════════════════")
    line()
    ...
    with ThreadPool(max_workers=100) as feel:
        ...
        tl=str(len(emran))
        print(" \033[38;5;46m════════════════════════════════════")
        print(f"\033[38;5;46m𝗙𝗕 𝗜𝗗 𝗦𝗔𝗩𝗘: /\033[38;5;47msdcard/\033[38;5;49m𝗘𝗠𝗥𝗔𝗡-𝗢𝗞.𝘁𝘅𝘁") 
